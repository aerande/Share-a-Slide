	...
	<div class="content_aftlogin" >
		...
		<section class="row1_aftlogin">
			<section class="sub_content_aftlogin">
				...
				<article class="ppt2">
				<figure>
					<img src="images/iot.jpg" alt="Internet of things" >
				</figure>
				<p class="para_heading">Internet of Things</p>
				<p class="para_text">Tips on Internet of Things Security</p>
				<p class="learnmore"><a href="/"> Learn more... </a></p>
				</article>
				<article class="ppt3">
				<figure>
					<img src="images/global.jpg" alt="Globalization" >
				</figure>
				<p class="para_heading">Digital Globalization</p>
				<p class="para_text">Flow Charts of Digital Globalization</p>
				<p class="learnmore"><a href="/"> Learn more... </a></p>
				</article>
			</section>
		</section>
