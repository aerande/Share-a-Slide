	...
	<div class="content_aftlogin" >
		...
		<section class="row1_aftlogin">
			<section class="sub_content_aftlogin">
				...
				<figure>
					<img src="images/thinkbig.jpg" alt="Think big" >
				</figure>
				<p class="para_heading">Magic to Think Big</p>
				<p class="para_text">Take time to dream and to think</p>
				<p class="learnmore"><a href="/"> Learn more... </a></p>
				</article>
				<article class="ppt2">
				<figure>
					<img src="images/ergonomics.jpg" alt="Office Ergonomics" >
				</figure>
				<p class="para_heading">Office Ergonomics</p>
				<p class="para_text">When it comes to ergonomics, Knowledge is Power</p>
				<p class="learnmore"><a href="/"> Learn more... </a></p>
				</article>
				<article class="ppt3">
				<figure>
